...
public class Label extends Actor
{
    ...
    {
        //this.value = Double.toString(Math.round(value*100.0)/100.0);
    ...
    private void updateImage()
    {
        ...
        GreenfootImage img = new GreenfootImage(145, 100);
        img.setColor(Color.PINK);
        img.setFont(new Font("Purple Smile", false, false , 45));
        img.drawString("$" + value, 10, 90);
        setImage(img);
    }
}